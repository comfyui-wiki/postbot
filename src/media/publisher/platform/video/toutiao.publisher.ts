 ...
 */
export const toutiaoVideoPublisher = async (data) => {
    console.log('toutiaoVideoPublisher data', data);
    ...
    const autoFillContent = (contentData) => {
        ...
        (editor as HTMLTextAreaElement).value = contentData?.description || contentData?.content;
